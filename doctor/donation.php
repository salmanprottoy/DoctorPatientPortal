        ...
        <div class="col-md-8 donor">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="uname" readonly value="<?php echo $userRow['d_name']; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="email" readonly value="<?php echo $userRow['d_email']; ?>">
                </div>
                <div class="form-group">
                    <label>Donor Blood group</label>
                    <select class="form-control" name="bGroup" readonly>
                        <option value="a+" <?php if ($userRow['d_bgroup'] == "a+") echo "selected"; ?>>A+</option>
                        <option value="a-" <?php if ($userRow['d_bgroup'] == "a-") echo "selected"; ?>>A-</option>
                        <option value="b+" <?php if ($userRow['d_bgroup'] == "b+") echo "selected"; ?>>B+</option>
                        <option value="b-" <?php if ($userRow['d_bgroup'] == "b-") echo "selected"; ?>>B-</option>
                        <option value="ab+" <?php if ($userRow['d_bgroup'] == "ab+") echo "selected"; ?>>AB+</option>
                        <option value="ab-" <?php if ($userRow['d_bgroup'] == "ab-") echo "selected"; ?>>AB-</option>
                        <option value="o+" <?php if ($userRow['d_bgroup'] == "o+") echo "selected"; ?>>O+</option>
                        <option value="o-" <?php if ($userRow['d_bgroup'] == "o-") echo "selected"; ?>>O-</option>
                    </select>
                </div>
